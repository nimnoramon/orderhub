...
export const th: Messages = {
  ...
  ask: {
    title: 'ถาม OrderHub',
    subtitle: 'ถามเรื่องข้อมูลจริงของร้านนี้ได้ คำตอบมาจากการอ่านชุดเดียวกับที่หน้าจออื่นใช้',
    placeholder: 'สินค้าไหนใกล้หมด',
    send: 'ถาม',
    sending: 'กำลังหา…',
    clear: 'เริ่มใหม่',
    suggestions: ['สินค้าไหนใกล้หมด', 'เมื่อวานขายช่องทางไหนดีที่สุด', 'ยังมีคำสั่งซื้อไหนรอแพ็กอยู่'],
    readFrom: (tools: string) => `อ่านจาก ${tools}`,
    failed: 'ผู้ช่วยตอบคำถามนี้ไม่ได้',
    disabled: 'เดโมชุดนี้ยังไม่ได้ตั้งค่า API key ของโมเดล ผู้ช่วยจึงปิดอยู่',
    footnote:
      'คำตอบเขียนโดย Claude จากการอ่านข้อมูลจริง ณ ตอนนั้น มันอ่านได้เฉพาะคำสั่งซื้อ สต็อก และช่องทางขายของร้านนี้ และแก้ไขอะไรไม่ได้ เรื่องสำคัญควรตรวจกับหน้าจออีกครั้ง',
  },
  ...
  landing: {
    ...
    milestones: [
      ...
      'ผู้ช่วยที่อ่านข้อมูลบนแดชบอร์ดได้',
    ],
  },
};
